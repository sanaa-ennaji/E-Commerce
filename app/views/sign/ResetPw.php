                    ...
                    <div class="flex-auto px-4 lg:px-10 py-2 pt-0">
                        ...
                        <form action="" method="post">
                            ...
                            <div class="text-center mt-6">
                                <button class="bg-green-500 text-white active:bg-green-700 text-sm font-bold uppercase px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 w-full" type="button" style="transition: all 0.15s ease 0s;">Send verification Email</button>
                            </div>
                        </form>
                    </div>
