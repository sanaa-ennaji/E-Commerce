        ...
        <div class="items-center lg:flex">
            <div class="w-full lg:w-1/2">
                <div class="lg:max-w-lg">
                    <h1 class="text-3xl font-semibold text-gray-800 dark:text-gray-700 lg:text-4xl">Best place to choose <br> your <span class="text-green-500 ">new clothes</span></h1>
                    ...
                    <button class="w-full px-5 py-2 mt-6 text-sm tracking-wider text-white uppercase transition-colors duration-300 transform bg-green-500 rounded-lg lg:w-auto hover:bg-green-700 focus:outline-none focus:bg-green-200">Shop Now</button>
                </div>
            </div>
            ...
            <div class="flex items-center justify-center w-full mt-6 lg:mt-0 lg:w-1/2">
                ...
                <img class="w-full h-full lg:max-w-3xl" src="https://img.freepik.com/free-vector/no-time-concept-illustration_114360-3974.jpg?size=626&ext=jpg" alt="Catalogue-pana.svg">
            </div>
        </div>
    </div>
</header>
...
<div class="container mx-auto my-6">
  <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 text-center">
    <div class="flex flex-col justify-center p-6 border-2 border-gray-300 rounded-xl">
    <!-- <i class="fa-regular fa-user my-2 md:mx-4 md:my-0"></i>
    <i class="fa-solid fa-sack-xmark"></i> -->
      <p class="text-2xl">Money back gurantee</p>
      <p>Shall open divide a one</p>
    </div>
    <div class="flex flex-col justify-center p-6 border-2 border-gray-300 rounded-xl">
      <p class="text-2xl">Free Delivery</p>
      <p>Shall open divide a one</p>
    </div>
    <div class="flex flex-col justify-center p-6 border-2 border-gray-300 rounded-xl">
      <p class="text-2xl">Alway support</p>
      <p>Shall open divide a one</p>
    </div>
    <div class="flex flex-col justify-center p-6 border-2 border-gray-300 rounded-xl">
      <p class="text-2xl">Secure payment</p>
      <p>Shall open divide a one</p>
    </div>
  </div>
</div>
